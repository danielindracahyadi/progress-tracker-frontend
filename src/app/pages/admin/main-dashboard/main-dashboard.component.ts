...
export class MainDashboardComponent implements OnInit {
  ...
  showResult() {
    ...
    if (
      this.selectedMainDashboardDropdown === "Project" ||
  ...
  onSubmit(searchResult: string) {
    ...
    this.searchDataProject = this.searchDataProject.filter(theData =>
      theData.projectname
        .toLowerCase()
        .includes(this.theSearchResult.toLowerCase())
    );
    this.searchDataRole = this.searchDataRole.filter(theData =>
      theData.rolename
        .toLowerCase()
        .includes(this.theSearchResult.toLowerCase())
    );

...
export class ExpansionTileComponent implements OnInit {
  ...
  doDetail() {
    this.mainDashboardService.setSelectedID(
      this.mainDashboard.theCurrentChoosenId
    );
    this.mainDashboardService.selectedName = this.mainDashboard.theCurrentChosen;
    this.mainDashboardService.setSelectedFilter(
      this.mainDashboard.theCurrentChoosenFilter
    );
    this.router.navigateByUrl("home-admin/main-dashboard-time");
  }

  doEdit() {
    this.modalService.setTheCurrentChosenID(
      this.mainDashboard.theCurrentChoosenId
    );
    ...
    if (
      this.mainDashboard.selectedMainDashboardDropdown === "" ||
      this.mainDashboard.selectedMainDashboardDropdown === "Project"
    ) {
